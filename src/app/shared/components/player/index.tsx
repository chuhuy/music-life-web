...
import { faPlay, faRandom, faStepBackward, faStepForward, faRedo, faPause} from '@fortawesome/free-solid-svg-icons';
        ...
        <>
            <div className="player-container row">
                <div className="player-left-section section-vertical-align">
                    <img src={songs[3].image_url} className="player-image" alt="Current Song"/>
                    <Col className="title-group">
                ...
                <div className="player-center-section section-vertical-align">
                    <div className="section-vertical-align">
                        ...
                        <button onClick={handlePausePlayClick} className="player-icon-button">
                            <div className="play-icon">
                                <FontAwesomeIcon icon={props.player.isPlaying ? faPause : faPlay} color="#FFF" size="1x" />
                            </div>
                        </button>
                        <button onClick={() => {}} className="player-icon-button">
                    ...
                    <div>
                        ...
                        <audio
                            ref={refs.audio}
                            src={songs[3].url}
                            onTimeUpdate={() => setCurrentTime(refs.audio.current ? refs.audio.current.currentTime : 0)}
                            onEnded={() => props.pauseMusic()}
                        />
                    </div>
                </div>
                <div className="player-right-section section-vertical-align">
